...
mstcvpt.M_Trafico Trafico, mstcvpt.M_Conversion 'Conversion (%)' ,  tdtc.Cumplimiento 'Cumplimiento Trafico',tdtc.CumpliminetoCv 'Cumplimiento Conversion' ,vc.Facturas 'Cantidad de Facturas',fcanu.v2 'anulados'
from
...
from TB_VISTA_COMERCIAL where Anulado=1 and Gestion=DATEPART(year,getdate()-21) and Semana=DATEPART(week,getdate()-21) and vc.Sucursal=Sucursal) v2
